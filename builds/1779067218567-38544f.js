...
function invokeOriginal(m, self, ...args) {
...
function patchHealthScriptIfPlayer(obj) {
...
function giveMoney(img) {
  try {
    ...
    invokeStatic(setCurrency, 102, INF_MONEY);
  } catch (_) {
  }
}
function unlockSkins(img) {
  try {
...
Il2Cpp.perform(() => {
  ...
  try {
    ...
    awake.implementation = function(...args) {
    ...
    initSkins.implementation = function(...args) {
