...
function giveMoney(img) {
  try {
    ...
    invokeStatic(setCurrency, 1, INF_MONEY);
    invokeStatic(setCurrency, 4, INF_MONEY);
    invokeStatic(setCurrency, 5, INF_MONEY);
  } catch (_) {
  }
}
