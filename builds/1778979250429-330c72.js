...
// agent.ts
var TARGET_ASSEMBLY = "Assembly-CSharp";
var CLASS_FILTER = "";
var LOG_ARGS = false;
var MAX_LOGS_PER_SECOND = 80;
var MAX_LOGS_PER_METHOD = 10;
var MAX_METHODS_TO_TRACE = 0;
var TRACE_PROPERTIES = true;
var TRACE_CONSTRUCTORS = true;
var TRACE_UPDATE_METHODS = true;
...
function installTrace(method, klassName) {
  try {
      ...
      try {
        for (const method of klass.methods) {
          ...
          if (MAX_METHODS_TO_TRACE > 0 && traceCount >= MAX_METHODS_TO_TRACE) {
            console.log("[!] Limite de m\xE9todos atingido: " + MAX_METHODS_TO_TRACE);
            console.log("[+] Classes analisadas: " + classCount);
            console.log("[+] M\xE9todos encontrados: " + methodCount);
            console.log("[+] Traces instalados: " + traceCount);
            console.log("[+] Falhas: " + failCount);
            return;
          }
          const ok2 = installTrace(method, klassName);
          if (ok2) {
            traceCount++;
          } else {
            failCount++;
