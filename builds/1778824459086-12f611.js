...
function findModuleByNameSafe(name) {
  try {
...
function listarModsImportantes() {
  ...
  for (const m of Process.enumerateModules()) {
    ...
    if (name.includes("gadget") || name.includes("il2cpp") || name.includes("unity") || name.includes("main") || name.includes("menu") || name.includes("egl")) {
